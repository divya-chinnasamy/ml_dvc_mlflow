...
if __name__ == "__main__":
    ...
    if t == 1:
        ...
        with mlflow.start_run() as lr_reg_run:
            ...
            mlflow.sklearn.log_model(model, "model",registered_model_name='lr_reg')
           
        # Prediction using logged model        
        import mlflow
        logged_model = 'runs:/30022d7d42954a6095da2e1dcc00d234/model'
        # Load model as a PyFuncModel.
        loaded_model = mlflow.pyfunc.load_model(logged_model)
        # Predict on a Pandas DataFrame.
        pred = loaded_model.predict(pd.DataFrame(x_test_fold))
        print(pred)
